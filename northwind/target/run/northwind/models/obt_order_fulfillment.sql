        ...
        create or replace transient table analytics.dbt_ty3340_northwind.obt_order_fulfillment
         as
        (with f_order_fulfillment as (
    select * from analytics.dbt_ty3340_northwind.fact_order_fulfillment
),
d_customer as (
